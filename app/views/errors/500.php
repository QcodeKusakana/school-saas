<?php
/**
 * Erreur 500 — page autonome, sans dépendance à la base de données.
 */
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .code { font-size: 3.75rem; font-weight: 700; color: #b91c1c; line-height: 1; margin: 0 0 .5rem; }
...
<body>
    <div class="box">
        ...
        <p>Une erreur est survenue de notre côté. L'incident a été enregistré et sera examiné.</p>
